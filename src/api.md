## API Report File for "eslint-config-escapace"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts
import type { Config as Config_2 } from 'typescript-eslint'
...
export type Config = Prettify<
  ...
  } & Omit<Awaited<Config_2> extends Array<infer T> ? T : unknown, 'rules'>
>

// @public
export const escapace: (options?: Options) => Promise<Config[]>
